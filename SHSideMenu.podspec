#
#  Be sure to run `pod spec lint SHSideMenu.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "홍성호"
  # s.authors            = { "홍성호" => "hsh3592@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/cozzin/SHSideMenu.git", :tag => "0.0.1" }
